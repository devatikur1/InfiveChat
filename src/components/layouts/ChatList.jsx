  ...
  return (
    ...
    >
      ...
      <nav className="w-full h-full flex flex-col overflow-auto custom-scroll">
        <ul className="w-full flex flex-col gap-3 pt-2 pb-3 px-2">
          {filterChatList.map((item) => (
            <React.Fragment key={item.id}>
              ...
              >
                ...
                >
                  {/* Avatar */}
                  <div className="relative z-40 shrink-0 select-none">
                    <img
                      src={item.avatar}
                      alt={item.name}
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex justify-between items-center">
                      <h3 className="font-medium text-[14px] md:text-[15px] truncate text-textPrimary/90 select-none">
                        {item.name}
                      </h3>
